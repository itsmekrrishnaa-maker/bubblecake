...
import { sendOrderToOwner, getOrderWhatsAppMessage } from '@/lib/whatsapp';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3 print:hidden">
        <button
          onClick={() => sendOrderToOwner(order)}
          className="flex-1 py-3 px-6 bg-green-500 text-white font-medium rounded-xl hover:bg-green-600 transition-colors flex items-center justify-center gap-2"
        >
