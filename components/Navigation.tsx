        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/admin"
                className="hidden md:flex p-2 text-gray-400 hover:text-indigo-600 transition-colors"
                title="Admin Panel"
              >
      ...
      >
        ...
        >
          ...
          <div className="mt-12 space-y-4">
            ...
            <Link
              href="/admin"
              className="block py-2 text-lg font-medium text-gray-400 hover:text-indigo-600 transition-colors"
              onClick={() => setIsMenuOpen(false)}
            >
              ⚙️ Admin
            </Link>
